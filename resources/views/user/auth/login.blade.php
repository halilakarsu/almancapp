    ...
    <div class="auth-card">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="form-group">
                <div class="input-wrapper">
                    ...
                    <input id="email" type="email" name="email" class="form-control" value="{{ old('email') }}" required autofocus placeholder="E-posta">
                </div>
                @error('email')
        ...
        @if (Route::has('register'))
            <p style="margin-top: 25px; font-weight: 600; color: var(--text-muted); font-size: 0.95rem;">
                Henüz hesabın yok mu? <a href="{{ route('register') }}" class="login-link" style="margin-top: 0;">Kayıt Ol</a>
            </p>
        @endif
    </div>
